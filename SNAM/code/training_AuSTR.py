...
for seed in seeds:
    ...
    for fold in [1,2,3,4,5]:
      ...
      sys.stdout = open("results/%s_seed%s_fold%s.txt"%(data,seed,fold), "w")
      print("fold",fold)
      tuning_model=[]
      tuning_lr=[]
      tuning_F1=[]
      for lr in lr_list:
       ...
       output_dir="models/%s_seed%s_fold%s_%lr"%(data,seed,fold,lr)
      ...
      tuning_df.to_csv("results/tuning_results/%s_seed%s_fold%s"%(data,seed,fold),sep="\t")
